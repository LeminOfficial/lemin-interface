        ...
        <div className="space-y-4">
          <div className="text-center flex gap-2">
            <div className="inline-flex items-center justify-center w-12 h-12 !bg-primary/10 rounded-lg">
              <svg className="w-6 h-6 bw-text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <div className='flex flex-col items-start'>
              <h3 className="text-lg font-semibold text-foreground mb-1">Find Your Stream</h3>
              <p className="text-sm text-muted-foreground">Enter the unique stream identifier</p>
            </div>
          </div>
          
          <form onSubmit={onSubmit} className="flex row-reverse justify-between px-1 items-center gap-4 w-full">
