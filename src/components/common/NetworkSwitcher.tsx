...
export const NetworkSwitcher= () => {
    ...
    const currentNetwork = networks.find(n => n.name === network) || networks[0];
                    ...
                    <div className="absolute top-full right-0 mt-2 w-56 bg-background border border-border rounded-lg shadow-lg z-20 overflow-hidden">
                        <div className="p-2">
                            ...
                            {networks.map((net) => (
                                ...
                                >
                                    <div className={`w-3 h-3 rounded-full ${net.color} flex-shrink-0`}></div>
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className={`text-xs ${
                                            net.name === network ? 'text-white/80' : 'text-muted-foreground'
                                        }`}>
                                            {net.description}
                                        </div>
                                    </div>
