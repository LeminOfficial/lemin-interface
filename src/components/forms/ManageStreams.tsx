...
import { StreamFilters } from '../stream/StreamFilters';
import { EmptyStreamState } from '../stream/EmptyStreamState';
  ...
  const filteredAndSortedStreams = useMemo(() => {
    let filtered = streams.filter(stream => {
      ...
      if (searchQuery) {
        ...
        return streamId.includes(query) || 
      ...
      <div className="mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground">Manage all your payment streams</p>
          </div>
            ...
            <div className="flex justify-center">
              <div className="flex items-center space-x-6 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-muted-foreground">Completed: {counts.completed}</span>
                </div>
                <div className="flex items-center space-x-2">
        ...
        {isLoading && (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Loading Streams</h3>
              <p className="text-muted-foreground">Fetching your streams from blockchain...</p>
            </div>
          </div>
        )}
        ...
        {!isLoading && streams.length > 0 && (
          <div className="flex justify-between items-center text-sm text-muted-foreground px-4">
            <span>
              Showing {filteredAndSortedStreams.length} of {streams.length} streams
